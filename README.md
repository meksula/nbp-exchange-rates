Krótki opis co zostało zrobione<br>
...
Mini dokumentacja ;)<br>
Mamy w aplikacji dostępne 2 endpointy zgodnie z dostarczoną specyfikacją.

1. Pobierz waluty z API NBP:<br>
URL: http://localhost:8080/api/v1/rates/EUR?effectiveDate=2026-06-08<br>
Metoda HTTP: GET<br>
